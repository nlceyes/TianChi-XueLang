...
# Cur Rev.2: ResNet34: batch_size=16, EPOCH=20, lr=0.0001, lr_step = 5, gamma=0.1
import datetime
import os
import time
import numpy as np
...
if __name__ == '__main__':
	...
	torch.save(model, 'model_ResNet34_E20.pth')
	...
	df.to_csv('..\\submit\\submit_' + date_flag + '_ResNet34_E20.csv', index=False)
